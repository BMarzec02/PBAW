        ...
        if ($this->validateSave()) {
            try {
                if ($this->form->id_przesylki == '') {
                    ...
                    Utils::addInfoMessage('Pomyślnie dodano przesyłkę. Twój numer przesyłki: ' . $trackingNumber);
                } else {
                    ...
                    Utils::addInfoMessage('Pomyślnie edytowano przesyłkę o numerze: ' . $trackingNumber);
                }
